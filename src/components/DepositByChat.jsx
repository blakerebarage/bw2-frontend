  ...
  return (
    <div className="min-h-[60vh] mt-12 flex flex-col items-center justify-center py-12 px-4 bg-[#1a1f24]">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-3 text-[#facc15]">Deposit by Chat Support</h2>
        <p className="text-gray-300 max-w-xl mx-auto">Get instant assistance with your deposits through our dedicated support channels</p>
      </div>
      {loading ? (
