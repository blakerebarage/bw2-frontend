...
const AllCommissionWalletagent = () => {
    ...
    const handleCommissionUpdate = (payload) => {
      if (payload && payload.data) {
        ...
        if (commissionData.length > 0) {
          ...
          setAllCommissions(filteredCommissions);
        }
      }
    };

    socket.on('wallet_commission_update', handleCommissionUpdate);

    return () => {
      socket.off('wallet_commission_update', handleCommissionUpdate);
    };
  ...
  const fetchCommissions = async () => {
    try {
      ...
      let url = `/api/v1/finance/all-wallet-agent-commissions?page=${currentPage}&limit=${limit}`;
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <div>
                <p className="text-sm text-gray-500">Wallet Agent</p>
                <p className="font-medium">{commission.walletAgentUsername}</p>
              </div>
            </div>
            <div className="space-y-2">
              <div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-[#1f2937] to-gray-800 px-6 py-6">
            <h1 className="text-2xl font-bold text-white text-center">
              All Commission Wallet Agent
            </h1>
            <p className="text-gray-300 text-center mt-2">
              Manage and view wallet agent commissions efficiently
            </p>
          </div>
                        ...
                        {filteredCommissions.map((commission) => (
                          <tr key={commission._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              {commission.walletAgentUsername}
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
...
export default AllCommissionWalletagent; 