import velkiLogo from "../../assets/ourbet.png";
...
const Setting = () => {
  return (
    <div>
      <div>
        <div className="flex flex-row md:justify-between  lg:justify-between  bg-[#1f2937]">
          ...
          <div className="md:pl-4 lg:pl-0 ml-1 md:ml-0 lg:ml-0 pt-0 lg:pt-6 flex flex-wrap lg:flex-row  justify-center items-center pr-2 space-x-2">
            <p>
              ...
              <span className="text-gray-300 text-xs lg:text-xl">
                - Main Balence:
              </span>{" "}
              <span className="text-gray-100  text-xs">USD 3,37,173.73</span>{" "}
            </p>
            <button className="   pl-1 mt-2 w-6 h-6  bg-gray-800  hover:bg-gray-700">
              <svg
