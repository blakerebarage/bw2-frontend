      ...
      <div className="mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-[#1f2937] to-gray-800 px-6 py-4">
            <h1 className="text-2xl font-bold text-white text-center">
              Live Bet List Management
            </h1>
            <p className="text-gray-300 text-center mt-1">
              Monitor and manage live betting activities
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <select className="flex-1 px-3 py-2.5 bg-white border-2 border-gray-200 rounded-lg focus:border-[#1f2937] focus:ring-2 focus:ring-[#1f2937] focus:ring-opacity-20 transition-all duration-200 outline-none text-sm">
                  <option value="100 tanx">100 tanx</option>
                  <option value="200 tanx">200 tanx</option>
                </select>
              </div>
              ...
              <div className="flex items-center">
                <p className="text-sm font-medium text-gray-500">
                  Total Records: <span className="text-[#1f2937] font-semibold">113</span>
                </p>
              </div>

              {/* Refresh Button */}
              <div className="flex justify-end">
                <button className="px-6 py-2.5 bg-[#1f2937] text-white rounded-lg hover:bg-gray-800 transition-colors duration-200 text-sm font-medium shadow-sm hover:shadow-md">
                  Refresh
                </button>
              </div>
            </div>
          ...
          <div className="border-b border-gray-200">
            <div className="bg-[#1f2937] px-6 py-3">
              <h2 className="text-lg font-semibold text-white">Unmatched Bets</h2>
            </div>
          ...
          <div>
            <div className="bg-[#1f2937] px-6 py-3">
              <h2 className="text-lg font-semibold text-white">Matched Bets</h2>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  <tr>
                    <td colSpan="11" className="px-6 py-4 text-center text-gray-600">
                      You have no bets in this time period
                    </td>
                  </tr>
                </tbody>
