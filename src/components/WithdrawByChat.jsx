  ...
  return (
    <div className="min-h-[60vh] mt-12 flex flex-col items-center justify-center py-12 px-4" style={{ background: 'linear-gradient(to bottom, #111827cc, #1f2937cc)' }}>
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-3 text-white">Withdraw by Chat Support</h2>
        <p className="text-gray-400 max-w-xl mx-auto">Get instant assistance with your withdrawals through our dedicated support channels</p>
      </div>
      {loading ? (
