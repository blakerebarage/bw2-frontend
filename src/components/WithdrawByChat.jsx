    ...
    <div className="min-h-[60vh] mt-12 py-12 px-4 bg-gradient-to-b from-[#009245]/5 to-white">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-3 text-[#009245]">Withdraw by Chat Support</h2>
          <p className="text-gray-600 max-w-xl mx-auto">
            Get instant assistance with your withdrawals through our dedicated support channels
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center bg-white p-8 rounded-xl border border-[#009245]/20 shadow-lg">
            ...
            <p className="text-lg font-medium text-gray-800 mb-2">No withdraw numbers available</p>
