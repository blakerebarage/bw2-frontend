...
import ourbet from "../../assets/ourbet.png";

const TopBar = () => {
  return (
    <div className="px-3 py-3 flex justify-between gap-1 bg-[#1f2937]">
      <button className="md:hidden text-gray-300">
        <CgMenuGridR size={30} />
      </button>
      <img className="w-20 lg:w-28 h-8 lg:h-12 mx-3" src={ourbet} alt="" />
      <div className="flex justify-between items-center gap-1.5 lg:gap-2">
        ...
        <button className="hidden md:block pl-1 w-6 h-6 bg-gray-800 rounded-sm hover:bg-gray-700 border border-gray-700">
          <svg
