...
import vlogo from "../assets/ourbet.png";
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (loginData.token) {
        ...
        if (!userData?.data?.role || userData?.data?.role === "user") {
          dispatch(logout());
      ...
      addToast("Provide valid phoneOrUserName and password", {
        appearance: "error",
        autoDismiss: true,
      });
    }
