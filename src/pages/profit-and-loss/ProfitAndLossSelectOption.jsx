...
const ProfitAndLossSelectOption = () => {
  ...
  return (
    <div className="bg-[#262c32] p-4">
      ...
      {/* Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-[#1b1f23] bg-opacity-50 flex items-center justify-center z-50 w-full rounded-[4px]">
          <div className="bg-[#1b1f23] text-white rounded-[4px] p-6  shadow-lg w-11/12 max-w-md">
            ...
            <div className="flex flex-row items-center gap-4 bg-gray-900 p-2 rounded-md">
